...
```
# Output:
<img width="497" height="171" alt="image" src="https://github.com/user-attachments/assets/59ba2186-7f16-468a-b111-1a6020eadc8f" />
...
```
# Output:
<img width="345" height="191" alt="image" src="https://github.com/user-attachments/assets/cb6be17e-46f7-4655-85c2-d40561c8357b" />
...
```
# Output:
<img width="553" height="214" alt="image" src="https://github.com/user-attachments/assets/dd5bd259-71b9-4365-bd22-a6159bd2c71b" />
...
```
# Output:
<img width="505" height="120" alt="image" src="https://github.com/user-attachments/assets/2ecc792c-a0a3-49ed-8512-2c0d268f7dc4" />
...
void convertFirstCLastC(char str[]) {
    ...
    if (len > 1 && str[len - 1] >= 'a' && str[len - 1] <= 'z') {
...
```
# Output:
<img width="440" height="135" alt="image" src="https://github.com/user-attachments/assets/3f5e8258-f11f-4eed-ac08-ae4656683693" />
